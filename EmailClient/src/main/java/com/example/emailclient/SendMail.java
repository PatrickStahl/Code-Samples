...
public class SendMail {
    ...
    // setze Fokus auf To-Feld, da From-Feld schon ausgefüllt ist
    @FXML
    ...
    // Button, um CC-Empfänger zu bestätigen (falls mehrere geadded werden sollen)
    @FXML
    ...
    {
        // Fehler, falls leere Felder vorhanden sind
    ...
    // Funktion zum Versenden; Setup mit passenden Daten für die FSU-Jena
    private void send(String from, String to, String CC, String subject, String body) throws IOException, MessagingException {
        ...
        // Nachricht erstellen und Konfigurieren
    ...
    public void setFrom(String from)
    {
        ...
        textFieldFrom.setEditable(false); // From kann nicht geändert werden da Nutzer seine angegebene Email verwenden muss
    }
